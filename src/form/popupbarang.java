...
public class popupbarang extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(bcarip, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tblbarangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblbarangMouseClicked
        ...
        brg.jenisbrg = tblbarang.getValueAt(tabelBarang, 2).toString();
        brg.hb = tblbarang.getValueAt(tabelBarang, 3).toString();
        brg.hj = tblbarang.getValueAt(tabelBarang, 4).toString();
        
        brg.itemTerpilihBrg(); // Eksekusi fungsi penempelan teks di Form Nota
        this.dispose();        // Tutup form pop-up otomatis     
